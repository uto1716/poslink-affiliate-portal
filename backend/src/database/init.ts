...
export async function initDatabase() {
  try {
    ...
    const adminExists = await dbGet('SELECT COUNT(*) as count FROM users WHERE username = ?', ['admin']);
    ...
    const companiesCount = await dbGet('SELECT COUNT(*) as count FROM companies');
